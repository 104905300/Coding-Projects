# This is the Elixir version of the simple tester. Put this script in 
# the same directory as your compiled Poker module and run it as a 
# script using "elixir simple_tester_elixir.exs".
